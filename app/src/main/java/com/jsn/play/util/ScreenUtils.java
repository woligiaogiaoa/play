...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = (WindowManager) MApp.getApp().getSystemService(Context.WINDOW_SERVICE);
        if (wm == null) return -1;
    ...
    public static boolean isLandscape() {
        return MApp.getApp().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) MApp.getApp().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void setSleepDuration(final int duration) {
        Settings.System.putInt(
                MApp.getApp().getContentResolver(),
